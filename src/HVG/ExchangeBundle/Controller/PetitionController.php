...
class PetitionController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        return $this->render('HVGExchangeBundle:Petition:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('HVGExchangeBundle:Petition:new.html.twig', array(
            'newForm' => $newForm->createView(),
        ));
    }
    ...
    public function showAction(Petition $petition)
    {
        ...
        return $this->render('HVGExchangeBundle:Petition:show.html.twig', array(
            'petition' => $petition,
    ...
    {
        return $this->createForm('HVG\ExchangeBundle\Form\PetitionStatusType', $petition, array(
    ...
    {
        return $this->createForm('HVG\ExchangeBundle\Form\PetitionReferenceType', null, array(
    ...
    {
        return $this->createForm('HVG\ExchangeBundle\Form\PetitionActionType', $petitionAction, array(
    ...
    {
        return $this->createForm('HVG\ExchangeBundle\Form\PetitionObjectiveType', $petitionObjective, array(
    ...
    public function areaAction(Request $request)
    {
        ...
        return $this->render('HVGExchangeBundle:Petition:area.html.twig', array(
            'petitions' => $petitions,
            'newForm' => $newForm->createView(),
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function sentAction(Request $request)
    {
        ...
        return $this->render('HVGExchangeBundle:Petition:sent.html.twig', array(
            'petitions' => $petitions,
            'newForm' => $newForm->createView(),
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function receivedAction(Request $request)
    {
        ...
        return $this->render('HVGExchangeBundle:Petition:received.html.twig', array(
            'petitions' => $petitions,
            'newForm' => $newForm->createView(),
            'direction' => $direction,
            'sort' => $sort,
