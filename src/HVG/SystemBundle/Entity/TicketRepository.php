...
class TicketRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function findByUserZone($status = null, $community = null, $unitgroup = null, $unit = null, $sort, $direction, $user)
    {
        $qb = $this->getEntityManager()->createQueryBuilder('t');
    ...
    public function findByLiability($status = null, $community = null, $unitgroup = null, $unit = null, $sort, $direction, $user)
    {
        $qb = $this->getEntityManager()->createQueryBuilder('t');
        $qb = $qb->select('t', 'u', 'g', 'c', 'l')->from('HVGSystemBundle:Ticket', 't');
        $qb = $qb->join('t.unit', 'u');
        $qb = $qb->join('u.unitgroup', 'g');
        $qb = $qb->join('u.community', 'c');
        $qb = $qb->join('t.liability', 'l');

        $qb = $qb->andWhere('l.id = :user');
        $qb = $qb->setParameter('user', $user->getId());
