...
class ProviderAccountType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder 
            ->add('ncuenta', null, array(
                'label' => 'provideraccount.form.ncuenta',
                'attr'  => array( 'label_col' => 4, 'widget_col' => 8 ),
                'translation_domain' => 'HVGSystemBundle',
            )) 
            ->add('bank', null, array(
                'label' => 'provideraccount.form.bank',
                'attr'  => array( 'label_col' => 4, 'widget_col' => 8 ),
                'translation_domain' => 'HVGSystemBundle',
            )) 
            ...
            ->add('provider', null, array(
                'label' => 'provideraccount.form.provider',
                'attr'  => array( 'label_col' => 4, 'widget_col' => 8 ),
                'translation_domain' => 'HVGSystemBundle',
            ))
        ;
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'HVG\SystemBundle\Entity\ProviderAccount'
        ));
    }
    ...
    {
        return 'hvg_systembundle_provideraccount';
    }
